    ...
    <div className="flex flex-1 flex-col">
      <header className="border-b border-zinc-800 bg-zinc-950/95 backdrop-blur">
        <div className="mx-auto flex w-full max-w-7xl items-center gap-3 px-4 py-3">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg border border-rose-700/60 bg-rose-950/40 font-mono text-[13px] font-bold text-rose-300">
            🧬
          </div>
      ...
      <main className="mx-auto flex w-full max-w-7xl flex-1 items-start px-4 py-12">
        <div className="w-full rounded-2xl border border-zinc-800 bg-zinc-900/40 p-8">
          <div className="font-mono text-[11px] uppercase tracking-widest text-rose-400">
            neuroevolution
          </div>
