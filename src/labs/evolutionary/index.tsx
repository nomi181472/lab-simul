...
export function EvolutionaryLab() {
  return (
    <div className="flex flex-1 flex-col">
      <header className="border-b border-zinc-800 bg-zinc-950/95 backdrop-blur">
        <div className="mx-auto flex w-full max-w-7xl items-center gap-3 px-4 py-3">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg border border-amber-700/60 bg-amber-950/40 font-mono text-[13px] font-bold text-amber-300">
            ⬢
          </div>
